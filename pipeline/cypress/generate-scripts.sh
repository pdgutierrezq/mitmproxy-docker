...
DEV_REPORT_BASE_FILE_NAME="$TEMPLATE_REPORT_DIR/dev.html"
DEV_SCRIPT_BASE_FILE_NAME="$TEMPLATE_REPORT_DIR/script.js"
FULL_REPORT_BASE_FILE_NAME="$TEMPLATE_REPORT_DIR/full.html"
...
report "$CLOSURE_SCRIPT" $DEV_SCRIPT_BASE_FILE_NAME
