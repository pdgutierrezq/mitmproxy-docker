...
ssh -i "$KEY" "ec2-user@$EC2" <<'ENDSSH'
  import_project(){
     ...
     --header 'accept: */*' \
     --header 'Authorization: Basic YWRtaW46YWRtaW4=' \
     --form "file=@\"exported-project-$PROJECT_TYPE-$PROJECT_ID.xml\""
  ...
  import_project rest ETGtzo
  import_project rest FuQbLm
  import_project rest KNqM2U
  import_project rest MvGKro
  import_project rest mz8eSA
  import_project rest qzx9pb
  import_project rest WJBLM5
  import_project soap 7cGqrI
  import_project soap DNJ8nW
  import_project soap E5KUlt
